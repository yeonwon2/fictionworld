...
const ENGINE_JS = [
  ...
  '  var state = { nodeId:"start_node", stats:Object.assign({}, meta.initialStats||{}), history:[], inventory:[], quests:{}, flags:[], skills:[], exp:0, rankIndex:0, systemPoints:0, npcAffinity:{}, lastChoiceText:null, lastDeltas:{}, eraReached:initialEraReached() };',
  ...
  '  function reset(){ state = { nodeId:"start_node", stats:Object.assign({}, meta.initialStats||{}), history:[], inventory:[], quests:{}, flags:[], skills:[], exp:0, rankIndex:0, systemPoints:0, npcAffinity:{}, lastChoiceText:null, lastDeltas:{}, eraReached:initialEraReached() }; choicesOpen=true; }',
  '',
