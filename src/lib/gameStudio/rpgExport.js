...
const ENGINE_JS = [
  ...
  '  function storyLogs(){ return (state.storyLog&&state.storyLog.length)?state.storyLog:state.history.map(function(id){ var n=GAME.nodes[id]||{}; return {nodeId:id,speaker:n.speaker||"",text:n.text||""}; }); }',
