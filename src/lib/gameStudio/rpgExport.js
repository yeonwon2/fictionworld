...
@media(max-width:640px){ .rpg-vn-scene{height:clamp(140px, 26vh, 260px);} .rpg-vn-text-scroll{max-height:26vh;} #game{padding:10px}.rpg-topbar{position:sticky;top:4px;z-index:20;padding:7px 8px}.rpg-avatar{width:34px;height:34px}.rpg-topbar-points{display:none}.rpg-vn-choices{position:sticky;bottom:0;z-index:18;max-height:46vh;overflow-y:auto;padding:12px 4px calc(4px + env(safe-area-inset-bottom,0px));background:linear-gradient(to bottom,transparent 0,var(--rpg-bg) 14px)}.rpg-vn-choice{min-height:52px;padding:12px 13px;font-size:14px}.rpg-export-history{max-height:44vh} }
