...
const ENGINE_JS = [
  ...
  '',
  '  function renderTabs(){ var showInv=(archetype==="mystery"||archetype==="litrpg"||hasItemMechanic()); var showQuest=(archetype==="litrpg"); if(!showInv && !showQuest) return ""; var s=\'<div class="rpg-tabs-wrap">\';',
