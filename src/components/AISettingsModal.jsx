      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-border bg-muted/20 p-3 space-y-2">
            ...
            <div className="rounded-md bg-emerald-500/10 px-2.5 py-2 text-[11px] text-emerald-700 dark:text-emerald-300"><strong>Tiết kiệm lượt AI · Đang bật</strong><br />Ưu tiên dùng lại kết quả đã tạo và không tự gọi lại AI khi một lượt tạo lớn bị lỗi.</div>
          </div>
          <div>
