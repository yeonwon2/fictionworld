...
export default function GameDocEditor({ doc, onSave, saving, onAIGenerate, busy, gameType }) {
  const def = GAME_SCRIPT_DOC_BY_KEY[doc?.doc_key] ?? { key: "", file: "", title: "Tài liệu", role: "" };
