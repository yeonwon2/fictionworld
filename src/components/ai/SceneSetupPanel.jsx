...
import { Users, Rocket, Loader2, Info } from "lucide-react";

// Bảng thiết lập phân cảnh: chọn nhân vật xuất hiện + dàn ý
    ...
    <aside className="lg:sticky lg:top-16 lg:self-start space-y-4">
      <div className="rounded-2xl border border-border bg-card p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h2 className="font-display font-semibold">Thiết lập phân cảnh</h2>
        </div>
        <p className="text-xs text-muted-foreground mb-3">Chọn nhân vật & dàn ý — AI sẽ trích xuất hồ sơ từ Sổ Tay.</p>
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
        ...
        <textarea
          ...
          placeholder="VD: Mở đầu — hai师兄 sư huynh đệ trước cửa Linh Tiên Các. Khắc Doanh r- \nCảnh giới: Mộc Hương Viện, đêm trăng."
          rows={6}
