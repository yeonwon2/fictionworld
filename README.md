...
- Luật dùng đúng engine hiện có: cổng điểm min/max, cờ/vật phẩm, thua khi chỉ số sinh tồn ≤ ngưỡng và ô xét ending ẩn. AI phải báo cơ chế chưa hỗ trợ (ví dụ thua toàn cục ở ngưỡng trên hoặc luật phức tạp theo thời điểm); bản có cơ chế chưa hỗ trợ không được áp dụng một phần. Vẫn chạy QA và chơi thử sau khi duyệt để kiểm tra độ phủ điều kiện, khả năng đạt điểm và logic câu chuyện.
